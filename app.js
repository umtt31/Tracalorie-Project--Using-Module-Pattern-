                        ...
                        html += `
                            <li class="collection-item" id="item-${item.id}">
                                ...
                                <a href="#" class="secondary-content">
                                    <i class="fa fa-pencil edit-item" aria-hidden="true">x</i>
                                </a>
                            </li>
                        `;
                }
...
const App = ((ItemCtrl, UICtrl, StorageCtrl) => {
    ...
    const itemDeleteSubmit = e => {
        ...
        StorageCtrl.deleteItemFromStroge(currentItem.id);
    ...
    return {
        init: () => {
            // Anasini siktigimin undefined valuesunu kaldirma
            UICtrl.removeItems(ItemCtrl.getItemById(undefined));
            // Clear edit state 
            UICtrl.clearEditState();

            // Fetch item from data structor
